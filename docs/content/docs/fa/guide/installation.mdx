...
bash <(curl -Ls https://raw.githubusercontent.com/TEAMO233/3x-ui/main/install.sh) v3.4.0
```
...
[صفحهٔ releases](https://github.com/TEAMO233/3x-ui/releases) دانلود کنید، آن را
...
```bash
XUI_NONINTERACTIVE=1 bash <(curl -Ls https://raw.githubusercontent.com/TEAMO233/3x-ui/main/install.sh)
```

دایرکتوری [`deploy/`](https://github.com/TEAMO233/3x-ui/tree/main/deploy) در مخزن
